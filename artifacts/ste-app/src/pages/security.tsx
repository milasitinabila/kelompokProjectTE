  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Lapisan pertahanan sistem dan pemantauan audit real-time."
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        <Card className="xl:col-span-1">
          <CardHeader>
            <CardTitle>Lapisan Pertahanan</CardTitle>
            <CardDescription>Implementasi Keamanan 7 Lapis</CardDescription>
          </CardHeader>
        ...
        <Card className="xl:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Rekaman permanen semua perubahan sistem</CardDescription>
          </CardHeader>
          <CardContent>
            {loadingLogs ? (
